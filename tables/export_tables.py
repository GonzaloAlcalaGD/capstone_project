...
class Docker2Host():
    ...
    def container2host(self, table: str, containerID: str) -> bool:
        ...
        """
        filename = f'{table}_{pendulum.now().to_date_string()}'
        path = f'/Users/gonzo/Desktop/capstone_project/data_storage/pgdata/{table}/{filename}'
        final_path = self.generate_path(parent_path=f'/Users/gonzo/Desktop/capstone_project/data_storage/pgdata/{table}', table=table)
